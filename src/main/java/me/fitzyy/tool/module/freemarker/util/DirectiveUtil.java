...
package me.fitzyy.tool.module.freemarker.util;
...
import me.fitzyy.tool.module.freemarker.layout.BlockDirective;
import me.fitzyy.tool.module.freemarker.layout.ExtendsDirective;
import me.fitzyy.tool.module.freemarker.layout.OverrideDirective;
import me.fitzyy.tool.module.freemarker.layout.SuperDirective;
...
public class DirectiveUtil {
    ...
    public static TemplateDirectiveBodyOverrideWraper getOverrideBody(Environment env, String name)
        ...
        return (TemplateDirectiveBodyOverrideWraper)
                env.getVariable(DirectiveUtil.getOverrideVariableName(name));
    }
