...
package me.fitzyy.tool.module.datatables.domain;
...
public class DataTablesOutput<T> {
     ...
     * the data request. Note that it is strongly recommended for security reasons that you cast
     * this parameter to an integer, rather than simply echoing back to the client what it sent in
     * the draw parameter, in order to prevent Cross Site Scripting (XSS) attacks.
     */
    @JsonView(View.class)
    private int draw;
