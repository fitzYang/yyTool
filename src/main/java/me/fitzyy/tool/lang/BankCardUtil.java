 ...
 * 银行卡卡号的前6位是用来表示发卡银行或机构的，称为“发卡行识别码”(Bank Identification Number，缩写为“BIN”)。 银联标准卡是由国内各家商业银行
 * (含邮储、信用社)共同发行、符合银联业务规范和技术标准、卡正面右下角带有“银联”标识(目前，新发行的银联标准卡一定带有国际化的银联新标识 ，新发的非银联标准卡使用旧的联网通用银联标识)、
...
public class BankCardUtil {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BankCardUtil.class);
    ...
    public static boolean checkBankCard(String cardId) {
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("银行卡判断结果：" + isBankCard);
        }
        return isBankCard;
    }
